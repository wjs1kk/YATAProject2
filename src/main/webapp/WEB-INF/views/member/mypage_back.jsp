...
<script type="text/javascript">
	window.onload = function() {
		...
		var modifyMenu = document.getElementById("js-mypage-btn-profile");
		...
		function clickPoint() {
			document.getElementById('mypage_section_mypage').style.display = 'none';
			...
			document.getElementById('mypage_section_modify').style.display = 'none';
		}
	...
	function clickModify() {
		...
		document.getElementById('mypage_section_coupon').style.display = 'none';
		document.getElementById('mypage_section_my_review').style.display = 'none';
		document.getElementById('mypage_section_modify').style.display = 'block';
	}
				...
				<div class="row">
					...
					<div class="col-md-8 pb-6">
						...
						<div class="mypage-section" id="mypage_section_mypage"
							...
							<section class="carmore-section pt-md-0">
								<div class="container">
									<div class="container-loading-dot" id="mypage_loading_list"
										style="display: 'none';">
										<div></div>
										<div></div>
										<div></div>
						...
						<!-- 내 정보 수정 비밀번호 확인 -->
						<div
							class="row no-gutters slider-text justify-content-start align-items-center justify-content-center confirm_passwd"
							style="display: none" onclick="confirmPasswd()">
							<div class="col-lg-8 ftco-animate">
								<div class="text w-100 text-center mb-md-5 pb-md-5">
									<div>
										<label for="inputPassword" class="visually-hidden">Password</label>
										<div class="d-flex justify-content-center">
											<input type="password" id="member_passwd"
												name="member_passwd" class="w-50 form-control"
												placeholder="Password" required>
										</div>
										<br>
										<button class="w-50 btn btn-lg btn-primary"
											style="width: 350px;" type="submit">비밀번호 확인</button>
									</div>
								</div>
							</div>
						</div>
						<!-- mypage_section_modify -->
						<div class="text w-100 text-center mb-md-5 pb-md-5"
							id="mypage_section_modify" style="display: none;">
								...
								<div>
									...
									<div class="d-flex justify-content-center">
										<input type="text" id="inputPassword"
											class="w-50 form-control" placeholder="비밀번호"
											value="${member_passwd }" required>
									</div>
									<label for="inputPassword2" class="visually-hidden">Confirm
										Password</label>
									<div class="d-flex justify-content-center">
										<input type="text" id="inputPassword2"
											class="w-50 form-control" placeholder="비밀번호 확인"
											value="${member_passwd }" required>
									</div>
									...
									<button class="w-50 btn btn-lg btn-primary"
										style="width: 350px;" type="submit">수정</button>
									<button class="w-50 btn btn-lg btn-primary"
										style="width: 350px;" type="reset">취소</button>
								</div>
							</form>
						</div>
					</div>
