			...
			<div class="container py-5">
				<div class="row">
										...
										<div
											...
											<div
												...
												<img
													...
													height="26px"><a href="history" class="color-grey-3 text-14">예약내역</a>
											</div>
											<div
												...
												<img
													...
													height="26px"><a href="review" class="color-grey-3 text-14">나의리뷰</a>
											</div>
										</div>
					...
					<div class="col-md-8 pb-6">
						<div class="mypage-section" id="mypage_section_mypage" style="">
							<section class="carmore-section pt-md-0">
								<div class="container">
									<div class="container-loading-dot"
										id="js_mypage_loading_rent_list" style="display: none;">
										<div></div>
										<div></div>
										<div></div>
									</div>
